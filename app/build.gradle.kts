...
android {
    ...
    buildFeatures {
        // Mengaktifkan ViewBinding untuk mempermudah akses view
        viewBinding = true
    }
    buildTypes {
        release {
...
dependencies {
    ...
    // Dependensi yang diambil dari katalog libs (versi dikelola di gradle/libs.versions.toml)
    ...
    // Dependensi untuk instrumented testing (JUnit dan Espresso)
